<template>
    <div>
        ...
        <div class="cool-facts-area padding-80-0">
            <el-row type="flex" justify="center" :gutter="50" style="margin: 0">
                <el-col :span="4">
                    <transition name="fade-transform" mode="out-in">
                        <div class="single-cool-facts-area mb-80" v-show="showFacts">
                            <div class="icon">
                                <img src="../../assets/img/core-img/star.png" alt="">
                            </div>
                            <h2>
        ...
        <div class="popular-courses-area padding-80-0">
            ...
            <el-row type="flex" justify="center" :gutter="50" style="margin: 0">
                <el-col :span="6">
                    <transition name="fade-transform" mode="out-in">
                        <div class="single-popular-course" v-show="showCourses">
                            <img src="../../assets/img/bg-img/c1.jpg" alt="">
                ...
                <el-col :span="6">
                    <transition name="fade-transform" mode="out-in">
                        <div class="single-popular-course mb-80" v-show="showCourses">
                            <img src="../../assets/img/bg-img/c2.jpg" alt="">
                            <div class="course-content">
                                <h4>词汇</h4>
                                <div class="meta d-flex align-items-center">
                                    <a href="#">Tanma</a>
                ...
                <el-col :span="6">
                    <transition name="fade-transform" mode="out-in">
                        <div class="single-popular-course mb-80" v-show="showCourses">
                            <img src="../../assets/img/bg-img/c3.jpg" alt="">
                            <div class="course-content">
                                <h4>说明文写作</h4>
                                <div class="meta d-flex align-items-center">
                                    <a href="#">Tanma</a>
